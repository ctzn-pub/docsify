    ...
    var Scale = /** @class */ (function () {
      function Scale(vizContainerElement) {
        ...
        this.initialize = function () {
          var childIframes = _this.domVizContainer.getElementsByTagName(
            'iframe'
          );
          if (childIframes.length !== 1) {
            throw new ReferenceError(
              'The DOM element where you are embedding your visualization must contain EXACTLY one <iframe> element.'
            );
          }
          _this.domVizIframe = childIframes[0];
          _this.domVizContainer.style.transformOrigin =
            _this.transformOrigin || _this.scaleFrom;
        ...
        this.scaleViz = function (scaleDirection) {
          var vizPixels,
            windowPixels,
            offsetPixels,
            boundingRectangle = _this.domVizContainer.getBoundingClientRect();
          ...
          _this.domVizContainer.style.transform =
            'scale(' + scalingFactor + ')';
        };
      ...
      Object.defineProperty(Scale.prototype, 'maxScalePct', {
        ...
        set: function (scalePct) {
          if (!scalePct) this._maxScalePct = undefined;
          else this._maxScalePct = scalePct / 100;
        },
        enumerable: true,
        configurable: true,
      });
      Object.defineProperty(Scale.prototype, 'minScalePct', {
         ...
         */
        set: function (scalePct) {
          if (!scalePct) this._minScalePct = undefined;
          else this._minScalePct = scalePct / 100;
        },
        enumerable: true,
        configurable: true,
      });
